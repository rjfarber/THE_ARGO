## INPUTS_ExplicitChannelFlow2D.py
## by Ryan Farber 23 January 2015
## Last modified: 07 March   2015
"""
This is an INPUTS file tailored for the ExplicitChannelFlow2D problem.

NX,NY,NZ,DX,DY, and DZ are required constants to
...
##Problem Constants
my_fluid.NT  = 10             # number of time steps
my_fluid.NI  = 50             # number of iterations
my_fluid.DT  = 1E-2           # chosen for stability
my_fluid.NU  = 0.1            # viscous diffusion
my_fluid.RHO = 1.0            # density of the fluid
my_fluid.MAE = 1E-3           # maximum allowed error
...
my_fluid.PLT_TYP     = "quiver include boundaries"
my_fluid.LABEL       = "channel_flow"
...
## end INPUTS_ExplicitChannelFlow2D.py
