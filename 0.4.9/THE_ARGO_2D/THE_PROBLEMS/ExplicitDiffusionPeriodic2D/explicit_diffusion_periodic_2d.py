...
for cycles in xrange(my_fluid.cycle_start, my_fluid.NT+1):
    ...
    u[1:-1,1:-1] += my_fluid.diffuse_explicit_2d(u)
    v[1:-1,1:-1] += my_fluid.diffuse_explicit_2d(v)
...
## end explicit_diffusion_periodic_2d.py
