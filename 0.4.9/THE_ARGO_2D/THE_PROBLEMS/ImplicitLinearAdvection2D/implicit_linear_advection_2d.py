## implicit_linear_advection_2d.py
...
function by implicit linear advection in two dimensions.
"""
import glob
import numpy as np
...
for cycles in xrange(my_fluid.cycle_start, my_fluid.NT+1):
    ...
    u[1:-1,1:-1] = my_fluid.linear_advect_implicit_2d(u, XX,YY)
    v[1:-1,1:-1] = my_fluid.linear_advect_implicit_2d(v, XX,YY)
    ...
    # end if
# end for
file_name = get_file_name(cycles, my_fluid.MAX_CYC_MAG, my_fluid.LABEL,
                                                                   ext)
save_state([cycles, u,v, "NA","NA","NA", "NA","NA", "NA","NA"],
           file_name)


## end implicit_linear_advection_2d.py
