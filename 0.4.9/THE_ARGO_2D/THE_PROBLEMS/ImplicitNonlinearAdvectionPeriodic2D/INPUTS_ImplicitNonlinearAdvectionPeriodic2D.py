...
my_fluid.SAVE_FREQ = 8       # save state every SAVE_FREQ cycles
...
my_fluid.LABEL       = "implicit_nonlinear_periodic_hat"
...
## end INPUTS_ImplicitNonlinearAdvectionPeriodic2D.py
