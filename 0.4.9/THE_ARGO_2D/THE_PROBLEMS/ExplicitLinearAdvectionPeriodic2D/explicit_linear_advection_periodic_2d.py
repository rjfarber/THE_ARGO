...
#    AX = ((u[2:,1:-1]   + u[1:-1,1:-1])**2/4.0 -
#          (u[1:-1,1:-1] + )/my_fluid.DX

#    u[1:-1,1:-1] = u_old - my_fluid.DT*AX
#    v[1:-1,1:-1] = v_old - my_fluid.DT*AY

#    u[1:-1,1:-1] -= my_fluid.advect_explicit_CFD_2dX(u,v)
#    v[1:-1,1:-1] -= my_fluid.advect_explicit_CFD_2dY(u,v)

    u[1:-1,1:-1] -= my_fluid.linear_advect_explicit_2d(u)
    v[1:-1,1:-1] -= my_fluid.linear_advect_explicit_2d(v)
...
## end explicit_linear_advection_periodic_2d.py
