## explicit_vortex_2d.py
## by Ryan Farber 12 February 2015
## Last modified: 07 March    2015
"""
The purpose of this program is to apply the_argo's to propagate
a vortex explicitly.
"""
import glob
import numpy as np
...
for cycles in xrange(my_fluid.cycle_start, my_fluid.NT+1):
 ...
 #                 +   my_fluid.diffuse_explicit_2d(v) )
    ...
    cn[1:-1,1:-1] -= (my_fluid.nonlinear_advect_explicit_2d(cn, u,v))
 #                  +  my_fluid.diffuse_explicit_2d(cn))
