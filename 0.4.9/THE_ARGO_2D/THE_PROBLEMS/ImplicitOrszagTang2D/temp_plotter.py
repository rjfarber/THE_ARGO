...
fig = plt.figure(figsize=(30,24),dpi=900)
for datafile in datafiles:
    the_data = cPickle.load(open(datafile, "rb"))
    os.chdir(cur_path + "/Plots")
    
    plt_name1  = "vMagV2" + datafile[:-len(data_file_ext)] + plot_file_ext
    plt_name2  = "bEngV2" + datafile[:-len(data_file_ext)] + plot_file_ext
