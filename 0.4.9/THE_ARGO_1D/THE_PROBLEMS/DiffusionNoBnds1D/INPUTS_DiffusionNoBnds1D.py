## INPUTS_DiffusionNoBnds1D.py
## by Ryan Farber 21 January 2015
## Last modified: 22 January 2015
"""
This is an INPUTS file tailored for the DiffusionNoBnds1D problem.
...
##Problem Constants
my_fluid.NT = 200                            # number of time steps
my_fluid.NU = 0.3                            # viscous diffusion
my_fluid.S  = 0.3                            # stability constant
my_fluid.DT = ( my_fluid.S * my_fluid.DX**2  # chosen for stability
                    / my_fluid.NU ) 
##End Problem Constants

my_fluid.SAVE_FREQ = 20    # save state every SAVE_FREQ cycles

##State Constants
my_fluid.XMIN = XMIN
my_fluid.XMAX = XMAX

my_fluid.LABEL       = "hat_no_boundaries"
...
## end INPUTS_DiffusionNoBnds1D.py
