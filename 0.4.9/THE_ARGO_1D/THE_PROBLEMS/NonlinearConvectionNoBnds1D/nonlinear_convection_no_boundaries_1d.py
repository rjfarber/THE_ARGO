## nonlinear_convection_no_boundaries_1d.py
...
function by nonlinear convection in one dimension with no boundaries.
"""
import numpy as np
...
## end nonlinear_convection_no_boundaries_1d.py
