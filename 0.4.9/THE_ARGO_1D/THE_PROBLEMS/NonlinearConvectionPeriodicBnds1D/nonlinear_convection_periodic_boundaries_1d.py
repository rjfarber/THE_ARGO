## nonlinear_convection_periodic_boundaries_1d.py
...
function by nonlinear convection in one dimension
with periodic boundaries.
"""
import numpy as np
import sys; sys.path.insert(0, "../..")
import the_bnds_setter_1d as sb
sys.path.insert(0, "../../..")
...
## end nonlinear_convection_periodic_boundaries_1d.py
