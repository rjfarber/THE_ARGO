## linear_advection_1d.py
## by Ryan Farber 28 December 2014
## Last modified: 20 December 2015
"""
The purpose of this program is to apply The_Argo_1D to propagate a hat
function by linear advection in one dimension.
"""
import numpy as np
