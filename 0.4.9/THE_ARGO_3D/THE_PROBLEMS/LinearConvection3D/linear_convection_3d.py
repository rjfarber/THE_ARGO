## linear_convecton_3d.py
## by Ryan Farber  7 January 2015
...
u = np.ones( (NX,NY,NZ) ) # x-component of the velocity
v = np.ones( (NX,NY,NZ) ) # y-component of the velocity
w = np.ones( (NX,NY,NZ) ) # z-component of the velocity
