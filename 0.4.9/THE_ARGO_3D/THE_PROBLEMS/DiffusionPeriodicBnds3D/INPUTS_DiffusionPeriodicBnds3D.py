## INPUTS_DiffusionPeriodicBnds3D.py
## by Ryan Farber 24 January 2015
## Last modified: 24 January 2015
"""
This is an INPUTS file tailored for the DiffusionPeriodicBnds3D problem.
...
##Problem Constants
my_fluid.NT = 4000                             # number of time steps
...
##Save Constants
my_fluid.SAVE_FREQ = 200       # save state every SAVE_FREQ cycles
...
## end INPUTS_DiffusionPeriodicBnds3D.py
