## linear_convecton_fixed_boundaries_3d.py
...
function by linear convection in three dimensions with fixed boundaries.
"""
import numpy as np
...
## end linear_convection_fixed_boundaries_3d.py
