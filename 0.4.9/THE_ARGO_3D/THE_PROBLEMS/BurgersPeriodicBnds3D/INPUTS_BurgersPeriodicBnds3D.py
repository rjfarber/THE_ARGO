## INPUTS_BurgersPeriodicBnds3D.py
## by Ryan Farber 24 January 2015
## Last modified: 24 January 2015
"""
This is an INPUTS file tailored for the BurgersPeriodicBnds3D problem.
...
##Problem Constants
my_fluid.NT = 12000                            # number of time steps
my_fluid.S  = 9E-4                             # stability constant
my_fluid.NU = 0.01                             # viscous diffusion
my_fluid.DT = DX*DY*my_fluid.S/my_fluid.NU     # chosen for stability
...
## end INPUTS_BurgersPeriodicBnds3D.py
