## cavity_flow_div_only_3d.py
## by Ryan Farber 27 January 2015
## Last modified: 27 January 2015
"""
The purpose of this program is to apply the_argo to solve the
navier stokes equations in three dimensions for cavity flow, including
only the divergence terms in calculating the source term for the
...
## end cavity_flow_div_only_3d.py
